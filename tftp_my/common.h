...
#include <errno.h>			 /* gestionar errors*/ 
...
#define RFC1350_ERR_NOTDEF		0				 /* Not defined,see err. message*/ 
#define RFC1350_ERR_FNOFOUND	1				 /* File not found*/ 
...
#define RFC1350_ERR_UKNOWID		5				 /* Unknow transfer ID
*/ 
#define RFC1350_ERR_FEXITS		6				 /* File already exists*/ 
...
#define DISK_FUL_ERR				"Disk full, file can't be create.\n"
...
#define UNKNOW_ERR					"Unknown error.\n"
#define UNKNOW_TRANSFER_ID_ERR		"Unknown transfer ID.\n"
...
void printfError( char *buffer, int size);
